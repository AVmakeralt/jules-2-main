    ...
    pub fn iterator_abstractions() -> Vec<AbstractionInfo> {
        vec![
            AbstractionInfo {
                ...
                actual_code: "mov rax, [rsi+8]; add rax, rax; mov [rdi+8], rax; ret".to_string(),
                abstract_cost: 10.0,
                expected_cost: 10.0,
                actual_cost: 10.0,
            ...
            AbstractionInfo {
                ...
                actual_code: "cmp dword [rsi+8], 0; jle .skip; mov rax, [rsi+8]; .skip: ret".to_string(),
                abstract_cost: 15.0,
                expected_cost: 15.0,
                actual_cost: 15.0,
                status: VerificationStatus::Unknown,
            ...
            AbstractionInfo {
                ...
                actual_code: "xor rax, rax; .fold_loop: add rax, [rsi+8]; add rsi, 16; dec rcx; jnz .fold_loop; ret".to_string(),
                abstract_cost: 20.0,
                expected_cost: 20.0,
                actual_cost: 20.0,
                status: VerificationStatus::Unknown,
    ...
    pub fn container_abstractions() -> Vec<AbstractionInfo> {
        vec![
            AbstractionInfo {
                ...
                actual_code: "mov rcx, [rdi+8]; mov [rcx+rdx*8], rsi; inc qword [rdi+16]; ret".to_string(),
                abstract_cost: 5.0,
                expected_cost: 5.0,
                actual_cost: 5.0,
                status: VerificationStatus::Unknown,
            ...
            AbstractionInfo {
                ...
                actual_code: "mov rax, [rdi]; mov rcx, [rdi+8]; xor rdx, rdx; .iter_loop: cmp rdx, rcx; jge .done; lea r8, [rax+rdx*8]; inc rdx; jmp .iter_loop; .done: ret".to_string(),
                abstract_cost: 8.0,
                expected_cost: 8.0,
                actual_cost: 8.0,
                status: VerificationStatus::Unknown,
